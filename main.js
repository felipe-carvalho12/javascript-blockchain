...
const pingoCoin = new Blockchain()

pingoCoin.addBlock('mark')
pingoCoin.addBlock('mark')

pingoCoin.addTransaction(new Transaction('mark', 'elon', 40))
pingoCoin.addBlock('')

console.log(pingoCoin.getAddressBalance('mark'))
